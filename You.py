...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="Evw1Ka54ozd2ZnTFdVW9.01eD1U2qXh8Zi0WWzaO7Yq.10mVK0R1nCygZBjSZx0BnY8tH2gCUC7beYfk/Bk0Kp4=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Evc6GIv0PCpHhdVLKk2d.rKoPKTxMCMFwdYmmCA/nVq.l7K4aJ+2Ed8jlAqHw1r3VR/pnUsm2ev4nyBQW6Mqawc=")
ki.loginResult()

#ki2 = LINETCR.LINE()
#ki2.login(token="EuyiBWMKKWqYXgn8TXE8.5cUtJHsh7lErvWIAWOMzka.0um0ODvqkJb74qySDMw/1nIiNawL3AWyidoXFdQA3kk=")
#ki2.loginResult()

#ki3 = LINETCR.LINE()
#ki3.login(token="EusGVM40tbfjlLxEVqG6.qVBmYN871zBEZBbjWaPcbG.sRf9DO4n2Jwyn1HGqXDk2dxfqH2fZthj7S6nb1rJtFw=")
#ki3.loginResult()

#ki4 = LINETCR.LINE()
#ki4.login(token="EuMldZ0m3IRcIAWwWSIb.JbMyrZXO0GpNOsFTv4EYUW.kx7u3iJ++OuyrPsNBq/bp1px+Krv97j2qNwXkEgu5xs=")
#ki4.loginResult()

#ki5 = LINETCR.LINE()
#ki5.login(token="Et8Wx1WuxzehrbkK1gr5.t2YASUAp/AaCzR2D6s3/zq.gxJYOGcr05sB7W+nuN/bqRLgEFI3yXjMsVbruiQWxdA=")
#ki5.loginResult()
...
print u"login THIRD success"
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""||=====  F O R   U S E R  =====||
||กรุณาพิมพ์"[คำสั่ง]"เพื่อเข้าสู่หน้าเมนู||                   
"""
...
❂➣ 1-10 bye. - คิกเกอร์ออก
❂➣ แทค  - แทคสมาชิก
❂➣ จุด   - ตั้งจุดเชคคนอ่าน
❂➣ อ่าน  - รายชื่อคนอ่าน
❂➣ เชคกลุ่ม  - ข้อมูลกลุ่ม
❂➣ ลิสกลุ่ม  - กลุ่มทั้งหมด
❂➣ ยกเชิญ,ยก  - ยกเลิกเชิญ
❂➣ Mid @  - Midรายบุคคล
❂➣ ดึง  - เชิญคนเข้ากลุ่มด้วย.คท
❂➣ ดึง:  - เชิญคนเข้ากลุ่มด้วยMid
❂➣ ขาว  - แก้ดำ(ส่ง.คท)
❂➣ ดำ  - เพิ่มบัญชีดำ(ส่ง.คท)
❂➣ เชคดำ  - บัญชีดำ
❂➣ ล้างดำ  - ล้างบัญชีดำ
❂➣ เปิดลิ้ง
❂➣ ปิดลิ้ง
...
❂➣ Copy @  - คิกเกอร์1ก๊อพปี้
❂➣ Mybackup  - กลับร่างเดิม
❂➣ Backup  - คิกเกอร์1กลับร่าง
❂➣ Spam on/off  - ข้อความสแปม
❂➣ ไวรัส01  - ปล่อยไวรัส
❂➣ เชคค่า  - เชคค่าต่างๆ
||===== ❂  คำสั่งตั้งค่า ❂  =====||          
🔧 เปิดไลค์/ปิดไลค์    
...
Bots = [mid,kimid,"ud3511dd6ed90c47f33234c30640a3bc9","u4643a992d5e67267d60f230c71af8dbd"]
bot1 = cl.getProfile().mid
admsa = "ud3511dd6ed90c47f33234c30640a3bc9"
...
def bot(op):
    ...
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "ud3511dd6ed90c47f33234c30640a3bc9":
                    if "join:" in msg.text:
...
#                return
#            cl.sendText(op.param1,"บายๆ บักหำ😅โชดดีเด้อ😂\n(*´･ω･*)\nSelfbot by\n---YOU-BOT---")
#            print "MEMBER HAS LEFT THE GROUP"
#------------------ KICK OUT FORM GROUP
#        if op.type == 19:
#            if op.param2 in Bots:
#                return
#            cl.sendText(op.param1,cl.getContact(op.param2).displayName + " เป็นไงละ จุกละสิ😈")
              ...
              if msg.from_ in admin:
                ...
                if wait["leaveRoom"] == True:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"ออกแชทอัตโนมัติเปิดอยู่ 􀜁􀇔􏿿")
                else:
                    wait["leaveRoom"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"เปิดออกแชทอัตโนมัติ👈􀜁􀇔􏿿")
                    else:
                        cl.sendText(msg.to,"เปิดระบบออกแชทอัตโนมัติ👈􀜁􀇔􏿿")
            elif msg.text in ["Leave off","ปิดออก"]:
                if wait["leaveRoom"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ปิดอยู่👈􀜁􀇔􏿿")
                    else:
                        cl.sendText(msg.to,"ระบบออกแชทปิดอยู่👈􀜁􀇔􏿿")
                else:
                    wait["leaveRoom"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ปิดออกแชทอัตโนมัติ👈􀜁􀇔􏿿")
                    else:
                        cl.sendText(msg.to,"ปิดระบบออกแชทอัตโนมัติ👈􀜁􀇔􏿿")
                ...
                if wait["leaveRoom"] == True: md+="☞ ออกแชท → ✔\n"
                else: md+="☞ ออกแชต → ❌\n"
                ...
                if wait["autoAdd"] == True:
                    ...
                    wait["autoAdd"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"เปิดแอดอัตโนมัติ👈")
                    else:
                ...
                if msg.toType == 2:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "==============================\nActive readers:%s\n\n\n\nPassive readers:\n%s\n\n==============================\nIn the last seen point:\n[%s]\n==============================\n Powered By:--YOU-BOT--" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        print "ReadPoint Set..."
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
...
#----------------------------------------------------------------
                ...
                if wait["lang"] == "JP":
                    ki6.sendText(msg.to,"ปฏิเสธค้างเชิญเรียบร้อย")
                else:
...
#-----------------------------------------------------------
                    ...
                    if not AsulLogged:
                        ...
                        tm = "\n\n"+nowT+":"+nowM+":"+nowS
                        kk.sendText(user1,"ล็อคอินสำเร็จ...พร้อมใช้งานแล้ว (｀・ω・´)"+tm)
                    else:
...
#----------------------ADMIN COMMAND------------------------------#
              ...
              if msg.from_ in admin:
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to,"SELF BOT BY:--YOU-BOT--")

            elif cms(msg.text,["ผู้สร้าง","Creator"]):
                msg.contentType = 13
                msg.contentMetadata = {'mid': admsa}
                cl.sendText(msg.to,"    SELF BOT BY:--YOU-BOT-- 􀜁􀇔􏿿 ")
                cl.sendMessage(msg)
                cl.sendText(msg.to,"    https://line.me/ti/p/iq22c0hfS0    ")
...
#-----------------------------------------------------------
                ...
                start = time.time()
                ki.sendText(msg.to, "กำลังเช็คความเร็วคิกเกอร์...")
                elapsed_time = time.time() - start
...
#------------------------------------------------------------------	
 ...
 #------------------------------------------------------------------
             ...
             if msg.from_ in admin:           
              ...
              if msg.from_ in admin:
                wait["blacklist"] = {}
                cl.sendText(msg.to,"ไม่มีคนติดดำ")
...
#-----------------------------------------------
            elif msg.text in ["มา","มามะ","กุ๊กๆๆ","โม่ๆ"]:
...
#-----------------------------------------------
                        ...
                        k5.updateGroup(G)
#-----------------------------------------------
            elif msg.text in ["See you","ออก","กุเกลียดมึง","Sayonara"]:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
