...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="EuhRwPtgzap7ooLFZ7p0.NQMTLK8ffa+1IcBcR3NCya.pMTm8CxX8Xb5a/kNeqPGiLkh/uJHzD7IuX7jg/4Yvj4=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Eupza40tpGYb1feOY8Z4./Yv7XmacONyfdILfA44HLa.RAbP31aYsbBqSklyy5J6fczfK0zpm52qsoZtX1/d1eM=")
ki.loginResult()
...
Bots = [mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,"u9ea9ad964f05140ff58826c2af79dc60"]
bot1 = cl.getProfile().mid
admsa = "u9ea9ad964f05140ff58826c2af79dc60"
admin = "u9ea9ad964f05140ff58826c2af79dc60"
...
def bot(op):
    ...
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "uce7509c4071cd6e9de41d161fda0f034":
                    if "join:" in msg.text:
...
#                return
#            cl.sendText(op.param1,"ไปซะละ ลาก่อน\n(*´･ω･*)\nSelfbot by\n─━═অईທີມບວທຍມທູຕইঅ═━")
              ...
              if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "==============================\nActive readers:%s\n\n\n\nPassive readers:\n%s\n\n==============================\nIn the last seen point:\n[%s]\n==============================\n Powered By:THIRD々•┅──" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        print "ReadPoint Set..."
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
...
#----------------------ADMIN COMMAND------------------------------#
              ...
              if msg.from_ in admin:
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to,"SELF BOT BY:═ह MOS═")

            elif cms(msg.text,["ผู้สร้าง","Creator"]):
                msg.contentType = 13
                msg.contentMetadata = {'mid': admsa}
                cl.sendText(msg.to,"􀜁􀇔􏿿 SELF BOT BY:═ह MOS═ 􀜁􀇔􏿿 ")
                cl.sendMessage(msg)
                cl.sendText(msg.to,"􀜁􀇔􏿿 http://line.me/ti/p/EZi7LceWO_ 􀜁􀇔􏿿 ")
